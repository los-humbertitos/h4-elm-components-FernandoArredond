...
var $author$project$ExampleTest$tests = A2(
	...
	_List_fromArray(
		[
			...
			'1+1=2',
			function (_v0) {
				return A2($elm_explorations$test$Expect$equal, 1 + 1, 2);
			})
		]));
